...
<%
    ...
    // Get sender's email-ID, message & subject-line from contact.jsp page
    ...
    // receiver's email ID and password needs to be mentioned

     String to = "tyagishikha0525@gmail.com";

     String pass = "blahblah0525";
